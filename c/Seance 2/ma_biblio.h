...
{   int nombre ;
    ...
    do{printf("\n n : ");
        scanf("%d",&nombre);
    }while (nombre <= 0 || nombre > nmax);
    return(nombre);
}
//----------------------------
void saisir_tableau ( int t1[nmax], int nombre )
{int i ;
     for(i=0;i<nombre;i++){
...
//---------------------------------------
void afficher_tableau ( int t1[nmax], int nombre )
{ int i ;
    printf("t1 :");
    for(i=0;i<nombre;i++){
            printf("%d /",t1[i]);
...
// Fonction Somme
//-------------------------
int somme_tableau(int t1[nmax],int nombre)
{

    int S , i ;
    S = 0; // élément neutre de la somme est 0
    for(i=0;i<nombre;i++){
        S = S + t1[i];
    }
    return(S);
...
// Fonction Produit
//-------------------------
int produit_tableau(int t1[nmax],int nombre)
{
    int P,i;
    P = 1; // élément neutre du produit est 1
    for(i=0;i<nombre;i++){
        P = P * t1[i];
    }
    return (P);
...
// Fonction Moyenne
//-------------------------
float moyenne(int t1[nmax],int nombre)
{   int S;
    float M;
...
/*
int maximum(int t1[nmax],int nombre)
{
